...
export function createBusinessSentryAdapter(): BusinessSentryAdapter {
  ...
  return {
    ...
    connectRelationalSource: LIVE_ENDPOINTS.dataSourcesConnect ? h.connectRelationalSource : m.connectRelationalSource,
    listSourceDatasets: LIVE_ENDPOINTS.dataSourcesDatasets ? h.listSourceDatasets : m.listSourceDatasets,
    previewSourceDataset: LIVE_ENDPOINTS.dataSourcesPreview ? h.previewSourceDataset : m.previewSourceDataset,
    getSourceAgentMemory: LIVE_ENDPOINTS.dataSourcesAgentMemory ? h.getSourceAgentMemory : m.getSourceAgentMemory,
    listSavedAnomalyQueries: LIVE_ENDPOINTS.dataSourcesAnomalyQueries ? h.listSavedAnomalyQueries : m.listSavedAnomalyQueries,
