...
export function createBusinessSentryAdapter(): BusinessSentryAdapter {
  ...
  return {
    ...
    listConnectors: LIVE_ENDPOINTS.dataSources ? h.listConnectors : m.listConnectors,
    createConnector: LIVE_ENDPOINTS.dataSources ? h.createConnector : m.createConnector,
    updateConnector: LIVE_ENDPOINTS.dataSources ? h.updateConnector : m.updateConnector,
    refreshConnector: LIVE_ENDPOINTS.dataSources ? h.refreshConnector : m.refreshConnector,
    listDataSources: LIVE_ENDPOINTS.dataSources ? h.listDataSources : m.listDataSources,
    getDataSourcePreview: LIVE_ENDPOINTS.dataSources ? h.getDataSourcePreview : m.getDataSourcePreview,
    getSourceMemory: LIVE_ENDPOINTS.dataSources ? h.getSourceMemory : m.getSourceMemory,
    ...
    listDetectorRuns: LIVE_ENDPOINTS.detectors ? h.listDetectorRuns : m.listDetectorRuns,
